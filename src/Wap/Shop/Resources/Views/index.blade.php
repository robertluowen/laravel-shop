...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/pre_foot.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/pro-detail.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/showbox.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/layer.css')}}" id="layuicss-skinlayercss">
    <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/showbox.js')}}"></script>
    <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/jquery.js')}}"></script>
    <script type="text/javascript" src="{{asset('vendor/robertluowen/laravel-wap-shop/js/layer.js')}}"></script>
    <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/load_task.js')}}" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/control_type.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/group_buy.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/goods_list.css')}}">
    <style type="text/css">
...
<div class="popup" style="position:fixed;top: 36%;left: 0px;width: 100%;height: 100%;margin-left:0px;display:none;">
    ...
    <div class="code">
        <div style="overflow: hidden;">
            <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500630330.jpg')}}"  style="max-width: 100%;margin-top: 10px;"/>
...
<script language="javascript" src="{{asset('vendor/robertluowen/laravel-wap-shop/js/jweixin-1.0.0.js')}}"> </script>
...
<div class="com-content">
    ...
    <div style="width: 100%;background-color: #fff;padding: 10px 0px;">
        <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/public_assembly.js')}}"></script>
        <style>
    ...
    <!-- 轮播图 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/components.css')}}">
    <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/slick.js')}}"></script>
    <div class="slick">
        <div style="display:block;text-align:center;width:100%;height:175px;line-height:175px;">
            <a href="#">
                <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1497070640.png')}}" alt="" style="height:175px;max-width:100%/* ;height:auto; */display: inline-block !important;vertical-align: middle !important;">
            </a>
        </div>
    </div>
    ...
    <!-- 公告 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/limarquee.css')}}">
    <script src="{{asset('vendor/robertluowen/laravel-wap-shop/js/jquery.limarquee.js')}}"></script>
    <style>
        .hot {
            width: 100%;
            height: 40px;
    ...
    <div class="hot" style="position: relative; overflow: hidden;">
        <div class="notice-img">
            <a href="javascript:;"><img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/ad.png')}}"></a>
        </div>
    ...
    <!-- 导航 -->
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/robertluowen/laravel-wap-shop/css/navi.css')}}">
    <div class="navi">
        <div class="navi-item">
            <nav class="navi-item_row">
                <a href="http://tp.23673.com/wap">
				<span>
					<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/platform_nav_home1.png')}}"><span>首页</span>
				</span>
                </a>
                <a href="http://tp.23673.com/wap/goods/integralcenter">
				<span>
					<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/platform_nav_category1.png')}}"><span>积分中心</span>
				</span>
                </a>
                <a href="http://tp.23673.com/wap/index/discount">
				<span>
					<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/platform_nav_limit1.png')}}"><span>限时折扣</span>
				</span>
                </a>
                <a href="http://tp.23673.com/wap/goods/brandlist">
				<span>
					<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/platform_nav_joins1.png')}}"><span>品牌专区</span>
				</span>
                </a>
                <a href="http://tp.23673.com/wap/member/index">
				<span>
					<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/platform_nav_member1.png')}}"><span>会员中心</span>
				</span>
                </a>
    ...
    <div class="controltype">
        <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/hotsale.png')}}"/>
        <span class="control_l_content" style="color:#16D810;">清凉一夏</span>
        <!-- 		<img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/top_selling.png')}}"> -->
    </div>
            ...
            <li class="gooditem">
                <div class="imgs">
                    <a href="http://tp.23673.com/wap/goods/goodsdetail?id=380">
                        <img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500547407503.jpg')}}" style="max-width:100%;">
                    </a>
                </div>
                <div class="info">
            ...
            <li class="gooditem">
                <div class="imgs">
                    <a href="http://tp.23673.com/wap/goods/goodsdetail?id=382">
                        <img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500600767633.jpg')}}" style="max-width:100%;">
                    </a>
                </div>
                <div class="info">
            ...
            <li class="gooditem">
                <div class="imgs">
                    <a href="http://tp.23673.com/wap/goods/goodsdetail?id=381">
                        <img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500600673623.jpg')}}" style="max-width:100%;">
                    </a>
                </div>
                <div class="info">
            ...
            <li class="gooditem">
                <div class="imgs">
                    <a href="http://tp.23673.com/wap/goods/goodsdetail?id=383">
                        <img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500601152703.jpg')}}" style="max-width:100%;">
                    </a>
                </div>
                <div class="info">
    ...
    <!--  -->
    <!-- 促销模块 -->
    <!-- 	<div class="controltype" style="background-image:url({{asset('vendor/robertluowen/laravel-wap-shop/images/newproduct.png')}});background-repeat:no-repeat;height:50px;margin:0;width:100%">
            <hr />
            <span class="control_l_content">清凉一夏</span>
        </div>
        <div class="slick">
            <div><a href="http://tp.23673.com/wap"><img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/guanggao_cs_02.jpg')}}" alt=""></a></div>
        </div>
        <section class="members_goodspic">
            <ul>
                            <li class="gooditem">
                    <div class="img">
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=380"><img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/1500547407503.jpg')}}"></a>
                    </div>
                    <div class="info">
                        <p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=380">印花显瘦A字碎花真丝连衣裙女夏季2017新款欧洲站气质裙子女装潮</a></p>
                        <p class="goods-price"><em>￥359.00</em></p>
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=380"><div class="goods-buy"></div></a>
                            ...
                            <li class="gooditem">
                    <div class="img">
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=382"><img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/')}}picture/1500600767633.jpg"></a>
                    </div>
                    <div class="info">
                        <p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=382">M Queen独立制衣 优雅V领褶皱飘带系带修身长裙A字吊带连衣裙8915</a></p>
                        <p class="goods-price"><em>￥599.00</em></p>
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=382"><div class="goods-buy"></div></a>
                            ...
                            <li class="gooditem">
                    <div class="img">
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=381"><img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/')}}picture/1500600673623.jpg"></a>
                    </div>
                    <div class="info">
                        <p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=381">2016夏装新款夜店豹纹性感露背低胸女装超短裙抹胸紧身包臀连衣裙</a></p>
                        <p class="goods-price"><em>￥500.00</em></p>
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=381"><div class="goods-buy"></div></a>
                            ...
                            <li class="gooditem">
                    <div class="img">
                        <a href="http://tp.23673.com/wap/goods/goodsdetail?id=383"><img class="lazy" src="{{asset('vendor/robertluowen/laravel-wap-shop/')}}picture/1500601152703.jpg"></a>
                    </div>
                    <div class="info">
                        <p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=383">单鞋细高跟防水台鱼嘴女凉鞋2017春夏季新款复古刺绣高跟鞋40-42</a></p>
                        <p class="goods-price"><em>￥345.00</em></p>
    ...
    <dl class="sub-nav nav-b5">
        <dd id="buttom_home">
            <a href="http://tp.23673.com/wap">
                <div class="nav-b5-relative">
                    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/home_check.png')}}"/>
                    <span>首页</span>
                </div>
            </a>
        </dd>
        <dd id="buttom_classify">
            <a href="http://tp.23673.com/wap/goods/goodsClassificationList">
                <div class="nav-b5-relative">
                    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/classify_uncheck.png')}}"/>
                    <span>分类</span>
                </div>
            </a>
        </dd>
        <dd id="buttom_stroe" >
            <a href="http://tp.23673.com/wap/index/shopstreet">
                <div class="nav-b5-relative">
                    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/store_uncheck.png')}}"/>
                    <span>店铺街</span>
                </div>
            </a>
        </dd>
        <dd id="bottom_cart" >
            <a href="http://tp.23673.com/wap/goods/cart">
                <div class="nav-b5-relative">
                    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/cart_uncheck.png')}}"/>
                    <span>购物车</span>
                </div>
            </a>
        </dd>
        <dd id="bottom_member" >
            <a href="http://tp.23673.com/wap/Member/index">
                <div class="nav-b5-relative">
                    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/user_uncheck.png')}}"/>
                    <span>会员中心</span>
                </div>
            </a>
        </dd>
...
<div class="mask-layer-loading">
    <img src="{{asset('vendor/robertluowen/laravel-wap-shop/picture/mask_load.gif')}}"/>
</div>
